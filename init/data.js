...
const locationCoords = {
  ...
  Bali: [115.2191, -8.6405],
  Banff: [-115.5708, 51.1784],
  Miami: [-80.1918, 25.7617],
  Phuket: [98.3923, 7.8804],
  "Scottish Highlands": [-4.2247, 57.4778],
...
const listingCategories = [
  "beaches",        // Malibu cottage
  "countryside",    // Tuscany villa
  "camping",        // Treehouse Portland
  "beaches",        // Cancun beachfront
  "lakeside",       // Lake Tahoe cabin
  "iconic-cities",  // LA penthouse
  "mountains",      // Verbier chalet
  "farms",          // Serengeti safari
  "iconic-cities",  // Amsterdam canal
  "resorts",        // Fiji private island
  "countryside",    // Cotswolds cottage
  "iconic-cities",  // Boston brownstone
  "beaches",        // Bali bungalow
  "mountains",      // Banff cabin
  "iconic-cities",  // Miami Art Deco
  "resorts",        // Phuket villa
  "castles",        // Scottish castle
  "resorts",        // Dubai oasis
  "camping",        // Montana log cabin
  "beaches",        // Mykonos villa
  "camping",        // Costa Rica treehouse
  "countryside",    // Charleston cottage
  "iconic-cities",  // Tokyo apartment
  "lakeside",       // New Hampshire lakefront
  "resorts",        // Maldives overwater
  "arctic",         // Aspen ski chalet
  "beaches",        // Costa Rica beach house
];

sampleListings.forEach((listing, index) => {
  const coords = locationCoords[listing.location];
  if (coords) {
    listing.geometry = { type: "Point", coordinates: coords };
  }
  listing.category = listingCategories[index] || "rooms";
});
